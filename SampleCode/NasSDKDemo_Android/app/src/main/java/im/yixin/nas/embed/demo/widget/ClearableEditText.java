...
/**
 * Created by jixia.cai on 2021/3/2 11:13 AM
 */
class ClearableEditText extends AppCompatEditText {
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.mipmap.nas_demo_ic_clear);
    }
